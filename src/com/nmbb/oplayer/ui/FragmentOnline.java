	...
	private void initWebView() {
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public boolean shouldOverrideUrlLoading(WebView view,
					final String url) {
				//final String url="http://218.26.231.89/youku/69780F30C683576B384DA250D/030008010055477F51DE1E2D0FBACA79F165B8-B9E6-9615-FC14-F208C9F1D1E6.mp4";
...
//		root.add(new OnlineVideo("视频网站", R.drawable.logo_youku, 0));
		...
		root.add(new OnlineVideo("优酷视频", R.drawable.logo_youku, 0,
				"http://3g.youku.com"));
		root.add(new OnlineVideo("搜狐视频", R.drawable.logo_sohu, 0,
				"http://m.tv.sohu.com"));
		root.add(new OnlineVideo("乐视TV", R.drawable.logo_letv, 0,
				"http://m.letv.com"));
		root.add(new OnlineVideo("爱奇异", R.drawable.logo_iqiyi, 0,
				"http://3g.iqiyi.com/"));
		root.add(new OnlineVideo("PPTV", R.drawable.logo_pptv, 0,
				"http://m.pptv.com/"));
		root.add(new OnlineVideo("腾讯视频", R.drawable.logo_qq, 0,
				"http://3g.v.qq.com/"));
		root.add(new OnlineVideo("56.com", R.drawable.logo_56, 0,
				"http://m.56.com/"));
		root.add(new OnlineVideo("新浪视频", R.drawable.logo_sina, 0,
				"http://video.sina.cn/"));
		root.add(new OnlineVideo("土豆视频", R.drawable.logo_tudou, 0,
				"http://m.tudou.com"));
	}
}
